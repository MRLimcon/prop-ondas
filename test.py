...
for cond in [0, 160]:
    for c_squared in [80.2, 8020]:
        ...
        ew_format, ew = utils.make_coil(X, Y, Z, dx, 0.0033, 0.06, [0,0,0], 0, voltage)
        ...
        values1 = utils.get_electromagnetic_response(array_t, X, Y, Z, result, dx, response_params, show_response=False)
